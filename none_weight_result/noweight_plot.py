...
plt.title('Training Loss Dynamics (none-weighted ResNet-18)')
plt.xlabel('Epochs')
...
plt.title('Validation Accuracy Dynamics (none-weighted ResNet-18)')
plt.xlabel('Epochs')
...
plt.xlim([0.0, 1.0])
plt.ylim([0.0, 1.05])
plt.title('ROC Curve (none-weighted ResNet-18)')
